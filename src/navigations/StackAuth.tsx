  ...
  return (
    ...
    {isLoading && (
      ...
      >
        ...
        <Stack.Screen name="VerificationView" component={VerificationView} initialParams={{ correo: "" }}/>
        <Stack.Screen name="CreateNewPassword" component={CreateNewPassword} initialParams={{ dataAuth: "" }}/>
      </Stack.Navigator>
    </> 
  );
};
